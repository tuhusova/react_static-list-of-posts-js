...
aut aut aut maxime quia temporibus ut omnis`}],Cc=[{id:1,userId:1,title:"sunt aut facere repellat provident occaecati excepturi optio reprehenderit",body:`quia et suscipit
...
expedita consequatur consequatur dolores quia eos et placeat`}],zc=[{id:1,name:"Leanne Graham",username:"Bret",email:"Sincere@april.biz"},{id:2,name:"Ervin Howell",username:"Antonette",email:"Shanna@melissa.tv"},{id:3,name:"Clementine Bauch",username:"Samantha",email:"Nathan@yesenia.net"},{id:4,name:"Patricia Lebsack",username:"Karianne",email:"Julianne.OConner@kory.org"},{id:5,name:"Chelsey Dietrich",username:"Kamren",email:"Lucio_Hettinger@annie.ca"},{id:6,name:"Mrs. Dennis Schulist",username:"Leopoldo_Corkery",email:"Karley_Dach@jasper.info"},{id:7,name:"Kurtis Weissnat",username:"Elwyn.Skiles",email:"Telly.Hoeger@billy.biz"},{id:8,name:"Nicholas Runolfsdottir V",username:"Maxime_Nienow",email:"Sherwood@rosamond.me"},{id:9,name:"Glenna Reichert",username:"Delphine",email:"Chaim_McDermott@dana.io"},{id:10,name:"Clementina DuBuque",username:"Moriah.Stanton",email:"Rey.Padberg@karina.biz"}],Nc=({comment:e})=>j.jsxs("div",{className:"CommentInfo",children:[j.jsxs("div",{className:"CommentInfo__title",children:[j.jsx("strong",{className:"CommentInfo__name",children:e.name})," by ",j.jsx("a",{className:"CommentInfo__email",href:`mailto:${e.email}`,children:e.email})]}),j.jsx("div",{className:"CommentInfo__body",children:e.body})]}),Pc=({comments:e})=>j.jsx("div",{className:"CommentList",children:e.map(t=>j.jsx(Nc,{comment:t},t.id))}),Lc=({user:e})=>j.jsxs("p",{children:[" Posted by  ",j.jsx("a",{className:"UserInfo",href:`mailto:${e.email}`,children:e.name})]}),Tc=({post:e})=>j.jsxs("div",{className:"PostInfo",children:[j.jsxs("div",{className:"PostInfo__header",children:[j.jsx("h3",{className:"PostInfo__title",children:e.title}),e.user&&j.jsx(Lc,{user:e.user})]}),j.jsx("p",{className:"PostInfo__body",children:e.body}),e.comments.length>0?j.jsx(Pc,{comments:e.comments}):j.jsxs("div",{children:[j.jsx("hr",{}),j.jsx("b",{"data-cy":"NoCommentsMessage",children:"No comments yet"})]})]}),Mc=({posts:e})=>j.jsx("div",{className:"posts",children:e.map(t=>j.jsx(Tc,{post:t},t.id))});function Rc(e){return zc.find(t=>t.id===e)||null}function Dc(e){return Ec.filter(t=>t.postId===e)}const jc=Cc.map(e=>({...e,user:Rc(e.userId),comments:Dc(e.id)})),Oc=()=>j.jsxs("section",{className:"App",children:[j.jsx("h1",{className:"App__title",children:"Static list of posts"}),j.jsx(Mc,{posts:jc})]});em(document.getElementById("root")).render(j.jsx(Oc,{}));
